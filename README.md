...
- **Agente Inteligente (LangGraph + Google GenAI):** Integración con el modelo `gemini-2.5-flash` (este se puede cambiar en el arhivo `AI_Agent/main.py` línea 47) y un grafo de LangGraph capaz de tomar decisiones, invocar herramientas analíticas y mantener memoria (checkpointing).
